...
const Card: FC<CardProps> = ({ card, ...props }) => {
  ...
  return (
    <Div
      {...props}
      className="m-2 border rounded-2xl overflow-hidden shadow-2xl"
    >
      <div className="flex flex-col">
        <Div src={image} className="h-60" />
        <Div className="p-4" height="16rem " minHeight="22rem">
          ...
          <p className="mt-2 line-clamp-4 h-30 overflow-scroll">{paragraphs}</p>
